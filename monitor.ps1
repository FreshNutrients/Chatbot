...
switch ($Action.ToLower()) {
    ...
    default {
        Write-Host "Available actions: dashboard, health, analytics, config" -ForegroundColor Yellow
        Write-Host "Example: .\monitor.ps1 -ApiUrl 'https://your-app.azurecontainerapps.io' -ApiKey 'your-key'" -ForegroundColor White
    }
}
