# Test 1: No Context - Basic Request
Write-Host "=== TEST 1: NO CONTEXT ===" -ForegroundColor Green
Write-Host "Testing basic chat request with no context keywords in message" -ForegroundColor Yellow
...
$body = @{
    message = "What fertilizer do you recommend?"
} | ConvertTo-Json
