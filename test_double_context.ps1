# Test 3: Double Context - Crop + Application Type  
Write-Host "=== TEST 3: DOUBLE CONTEXT (CROP + APPLICATION) ===" -ForegroundColor Green
Write-Host "Testing chat request with crop and application type context in message" -ForegroundColor Yellow
...
$body = @{
    message = "What foliar fertilizer do you recommend for tomatoes?"
} | ConvertTo-Json
